...
bool operator ==(Object other) {
  final _this = this as ExampleItemDto;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExampleItemDto&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.title, _this.title) || other.title == _this.title));
}
...
String toString() {
  final _this = this as ExampleItemDto;
  return 'ExampleItemDto(id: ${_this.id}, title: ${_this.title})';
}
...
class _ExampleItemDto implements ExampleItemDto {
  const _ExampleItemDto({required this.id, required this.title});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExampleItemDto&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title));
}
