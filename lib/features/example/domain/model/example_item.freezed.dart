...
bool operator ==(Object other) {
  final _this = this as ExampleItem;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExampleItem&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.title, _this.title) || other.title == _this.title));
}
...
String toString() {
  final _this = this as ExampleItem;
  return 'ExampleItem(id: ${_this.id}, title: ${_this.title})';
}
...
class _ExampleItem implements ExampleItem {
  const _ExampleItem({required this.id, required this.title});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExampleItem&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title));
}
